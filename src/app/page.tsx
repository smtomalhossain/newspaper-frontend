          ...
          <div className="container">
            <div className="flex flex-wrap -ml-2.5 -mr-2.5">
              ...
              <div className="flex-none w-full lg:max-w-[44%] lg:w-1/2 md:w-1/2 px-2.5 sm:w-full">
                  ...
                  <div className="w-full sm:w-full">
                    <a href="">
                      <div className="h-auto overflow-hidden relative xl:h-auto">
                        <img className="h-auto w-full max-w-full object-cover" src="/top-news-1.jpg" alt="" />
                        <div className="bg-gradient-to-b p-[20px_10px_8px_10px] w-full absolute bottom-0 caption from-[rgba(0,0,0,0.02)] to-[rgb(0,0,0)]">
                          <h3 className=" text-3xl text-white font-bold leading-[35px]">‘ধর্ষণের সংজ্ঞায় পরিবর্তনসহ আইনে বেশ কিছু সংশোধনী আসছে: আসিফ নজরুল</h3>
                        </div>
                      </div>
                ...
                <div className="flex grid grid-cols-2 gap-4 lg:grid-cols-2 md:grid-cols-2 sm:grid-cols-2">
                  <div className=" bg-white w-full mt-5 self-stretch">
                    <a href="">
                      <div className="h-[100px] overflow-hidden relative xl:h-auto">
                        <img className="h-auto w-full max-w-full min-h-full object-cover" src="/news1.jpg" alt="" />
                      </div>
                      <h3 className="p-[5px_8px] text-[1.0em] font-bold leading-[25px] max-h-[90px] overflow-hidden">এবার এসএসসি-সমমানে পরীক্ষার্থী ১৯ লাখ ২৮ হাজার, কমেছে প্রায় ১ লাখ</h3>
                    </a>
                  ...
                  <div>
                    <div className=" bg-white w-full mt-5 self-stretch">
                      <a href="">
                        ...
                        <h3 className="p-[5px_8px] text-[1.0em] font-bold leading-[25px] max-h-[90px] overflow-hidden">এবার এসএসসি-সমমানে পরীক্ষার্থী ১৯ লাখ ২৮ </h3>
                      </a>
              ...
              {/* Second Column (26%) */}
              <div className="w-full lg:max-w-[26%] md:w-full px-2.5">
                    ...
                    <div className="grid grid-cols-12">
                      ...
                      <div className="col-span-4 lg:col-span-5 md:col-span-3 pr-[7px]">
                        ...
                        <div className="w-full lg:h-auto mb-[5px] overflow-hidden relative">
                          <img className="align-middle border-0 w-full max-w-full min-h-full object-cover" src="/second-row-new-1.jpg" alt="" />
                        </div>
                      </div>
                              ...
                              <div className="grid grid-cols-12 gap-2 mb-[2px]">
                                <div className="col-span-4 w-full">
                                  <div className=" w-full relative xl:h-auto">
                                    <img className="align-middle w-full img-fluid max-w-full min-h-full object-cover" src="/latest-news-1.jpg" alt="" />
                                  </div>
                                </div>
                          ...
                          <a href="">
                            <div className="w-full">
                              <div className="overflow-hidden relative lg:h-auto">
                                <img className="w-full max-w-full min-h-full h-auto object-cover" src="/natonal-news-1.jpg" alt="" />
                          ...
                          <a href="">
                            <div className="row">
                              <div className=" w-[34%] md:w-1/3 lg:w-[31.8%]">
                                <div className=" overflow-hidden relative lg:h-auto">
                                  <img className="w-full max-w-full min-h-full h-auto object-cover align-middle border-non" src="/natonal-news-2.jpg" alt="" />
                                </div>
                              </div>
                    ...
                    <div className="mt-7">
                      <div className="row">
                        <div className="w-full relative px-[10px]">
                          <div className="flex justify-center">
                            <img src="/350-250-add-1.jpeg" alt="" />
                          </div>
                        </div>
                      </div>
                    </div>
                ...
                <div className="row">
                    ...
                    <div className="bg-white w-full self-stretch">
                      <a href="">
                        <div className="lg:h-auto lg:overflow-hidden lg:relative">
                          <img className="w-full max-w-full min-h-full h-auto object-cover align-middle border-none" src="/all-bangla.jpg" alt="" />
                        </div>
                  ...
                  <div className="w-1/2 sm:w-1/2 px-2.5 md:w-1/2 flex">
                    <div className="bg-white w-full self-stretch">
                      <a href="">
                        <div className="lg:h-auto lg:overflow-hidden lg:relative">
                          <img className="w-full max-w-full min-h-full h-auto object-cover align-middle border-none" src="/all-bangla-1.jpg" alt="" />
                        </div>
                    ...
                    <div className="mt-5 self-stretch">
                      <a href="">
                        <div className="overflow-hidden relative xl:h-auto">
                          <img className="w-full max-w-full min-h-full h-auto object-cover align-middle border-none" src="/all-bangla-3.jpg" alt="" />
                        </div>
              ...
              <div className="row">
                ...
                <div className=" w-full md:w-1/2 px-2.5 mb-3 lg:w-1/2">
                  <div className="bg-white !h-auto">
                    <a href="">
                      <div className="overflow-hidden relative lg:h-auto">
                        <img className="w-full h-auto max-w-full min-h-full object-cover align-middle border-none" src="/sports-news.jpg" alt="" />
                      </div>
                ...
                <div className="w-1/2 lg:w-1/4 md:w-1/4 md:order-first order-none px-2.5 lg:order-first">
                  ...
                  <div className="bg-white mb-5">
                    <a href="">
                      <div className="overflow-hidden relative lg:h-auto">
                        <img className="w-full h-auto max-w-full min-h-full object-cover align-middle border-none" src="/sports-news-2.jpg" alt="" />
                      </div>
                      <div className="px-[8px] py-[5px] h-[60px] overflow-hidden">
                ...
                <div className="w-1/2 lg:w-1/4 md:w-1/4 order-none px-2.5">
                  <div className="bg-white mb-5">
                    <a href="">
                      <div className="overflow-hidden relative lg:h-auto">
                        <img className="w-full h-auto max-w-full min-h-full object-cover align-middle border-none" src="/sports-news-3.jpg" alt="" />
                      </div>
                      <div className="px-[8px] py-[5px] h-[60px] overflow-hidden">
                  ...
                  <div className="bg-white mb-5">
                    <a href="">
                      <div className="overflow-hidden relative lg:h-auto">
                        <img className="w-full h-auto max-w-full min-h-full object-cover align-middle border-none" src="/sports-news-4.jpg" alt="" />
                      </div>
                      <div className="px-[8px] py-[5px] h-[60px] overflow-hidden">
              ...
              <div className="row">
                <div className="w-full md:w-full lg:w-5/12 px-2.5 mb-4">
                  <div className="bg-white">
                    <a href="">
                      <div className="overflow-hidden relative lg:h-auto">
                        <img className="w-full h-auto max-w-full min-h-full object-cover align-middle border-none" src="/entertainment-news.jpg" alt="" />
                      </div>
                    ...
                    {entertainmentData.map((items, index) => (
                      <div key={index} className="w-1/2 px-2.5 md:w-1/2 lg:w-1/3 lg:px-2.5  flex">
                        ...
                        <div className="bg-white mb-[10px] lg:mb-[20px] w-full self-stretch">
                          <a href="">
                            <div className="overflow-hidden relative lg:h-auto">
                              <img className="w-full h-auto max-w-full min-h-full object-cover align-middle border-none" src={items.image} alt="" />
                            </div>
                            <div className="px-[8px] py-[5px] h-[60px] overflow-hidden">
                    ...
                    <a href="">
                      <div className="w-full">
                        <div className="relative">
                          <img className="w-full max-w-full h-auto align-middle border-none" src="/news-1.jpg" alt="" />
